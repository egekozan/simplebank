...
// Source: github.com/egekozan/simplebank/db/sqlc (interfaces: Store)
...
// GetAccounForUpdate mocks base method.
func (m *MockStore) GetAccounForUpdate(arg0 context.Context, arg1 int64) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccounForUpdate", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAccounForUpdate indicates an expected call of GetAccounForUpdate.
func (mr *MockStoreMockRecorder) GetAccounForUpdate(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccounForUpdate", reflect.TypeOf((*MockStore)(nil).GetAccounForUpdate), arg0, arg1)
}
